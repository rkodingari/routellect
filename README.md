...
G6 is approved. Version 0.5.0 is the completed local release candidate; it has not been published or
deployed. The publication conditions in the G6 verification report remain mandatory. At the primary
R2-Bench operating point, the hybrid segment policy ties the global baseline and therefore is not
recommended for production despite satisfying the minimum non-regression rule. An exploratory
higher cost-weight point is promising but not confirmatory. Current evidence must not be interpreted
as a universal ranking or a claim of best model quality.
